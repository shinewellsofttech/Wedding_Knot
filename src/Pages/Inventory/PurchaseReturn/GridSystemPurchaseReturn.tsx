...
const tableStyles = `
  .purchase-return-grid-wrap {
    overflow-x: auto;
    -webkit-overflow-scrolling: touch;
    margin-left: -0.25rem;
    margin-right: -0.25rem;
  }
  .purchase-return-grid-wrap .po-table {
    min-width: 950px;
    margin-bottom: 0;
  }
  ...
  @media (max-width: 991.98px) {
    .purchase-return-grid-wrap .po-table { min-width: 900px; }
  ...
  @media (max-width: 767.98px) {
    .purchase-return-grid-wrap .po-table { min-width: 850px; }
...
const GridSystemPurchaseReturn: React.FC<GridSystemPurchaseReturnProps> = ({
  ...
  return (
    <>
      ...
      <Row className="mb-3">
        <Col xs="12">
          <div className="table-responsive purchase-return-grid-wrap">
