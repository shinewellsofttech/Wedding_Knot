          ...
          <Col xs="12">
            <Card>
              ...
              <CardBody className="p-2 p-sm-3">
                <Row className="g-2 g-sm-3">
                  <Col md="2">
                    ...
                    <select className="form-control" value={state.formData.F_PurchaseEntryH || ""} onChange={(e) => { handleFormFieldChange("F_PurchaseEntryH", e.target.value); fetchPEDataAndPopulateGrid(e.target.value); }}>
                  ...
                  <Col md="2">
                    ...
                    <select className="form-control" value={state.formData.F_VendorMaster} onChange={(e) => handleFormFieldChange("F_VendorMaster", e.target.value)} disabled={state.isEditMode}>
              ...
              <CardFooter className="d-flex flex-row flex-nowrap gap-2 justify-content-end p-2 p-sm-3">
                ...
                <Btn color="success" type="button" className="m-0" onClick={handlePrint}><i className="bx bx-printer me-2"></i>Print</Btn>
