...
const tableStyles = `
  .sales-return-grid-wrap {
    overflow-x: auto;
    -webkit-overflow-scrolling: touch;
    margin-left: -0.25rem;
    margin-right: -0.25rem;
  }
  .sales-return-grid-wrap .po-table {
    min-width: 950px;
    margin-bottom: 0;
  }
  ...
  @media (max-width: 991.98px) {
    .sales-return-grid-wrap .po-table { min-width: 900px; }
  ...
  @media (max-width: 767.98px) {
    .sales-return-grid-wrap .po-table { min-width: 850px; }
...
interface GridSystemSalesReturnProps {
  gridRows: GridRow[];
  itemGroupMaster: any[];
  itemMaster?: any[];
  colorMaster?: any[];
...
const GridSystemSalesReturn: React.FC<GridSystemSalesReturnProps> = ({
  gridRows,
  itemGroupMaster,
  itemMaster = [],
  colorMaster = [],
  ...
  return (
    <>
      ...
      <Row className="mb-3">
        <Col xs="12">
          <div className="table-responsive sales-return-grid-wrap">
...
export default GridSystemSalesReturn;
